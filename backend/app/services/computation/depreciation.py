def compute_depreciation(purchase_price: float, land_value_pct: float, furniture_cost: float) -> dict:
    ...
    return {
        ...
        "total_depreciation_annual": building_depreciation_annual + furniture_depreciation_annual,
    }
