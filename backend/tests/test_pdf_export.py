...
def setup_ltr_property(client):
    ...
    client.put(f"/api/properties/{pid}/ltr-assumptions", json={
        "monthly_rent": 2200,
...
class TestCharts:
    def test_projection_chart_returns_png(self):
        ...
        projections = [
            {"year": y, "annual_cashflow": 5000 * y, "equity": 50000 + 10000 * y, "property_value": 400000 + 10000 * y}
            for y in range(1, 6)
        ]
    ...
    def test_sensitivity_chart_returns_png(self):
        ...
        occ_sweep = [{"occupancy_pct": o, "monthly_cashflow": (o - 50) * 20} for o in range(30, 101, 5)]
        rate_sweep = [{"nightly_rate": r, "monthly_cashflow": (r - 150) * 5} for r in range(140, 261, 10)]
    ...
    def test_ltr_sensitivity_chart_returns_png(self):
        ...
        vac_sweep = [{"vacancy_pct": v, "monthly_cashflow": 500 - v * 30} for v in range(0, 26)]
        rent_sweep = [{"monthly_rent": r, "monthly_cashflow": r - 1800} for r in range(1500, 2600, 100)]
